...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "DebugBundle:Profiler:dump.html.twig", "/home/zaamiqana/Delivery/Projet_Perso/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/views/Profiler/dump.html.twig");
    }
}
